...
public class C3Parser implements PsiParser, LightPsiParser {
  ...
  public static boolean asm_declaration(PsiBuilder b, int l) {
    ...
    r = p && report_error_(b, asm_declaration_2(b, l + 1)) && r;
  ...
  public static boolean bitstruct_declaration(PsiBuilder b, int l) {
    ...
    r = p && report_error_(b, bitstruct_declaration_2(b, l + 1)) && r;
  ...
  public static boolean const_declaration_stmt(PsiBuilder b, int l) {
    ...
    p = r; // pin = 1
    r = r && report_error_(b, const_declaration_stmt_1(b, l + 1));
    r = p && report_error_(b, consumeToken(b, CONST_IDENT)) && r;
    r = p && report_error_(b, const_declaration_stmt_3(b, l + 1)) && r;
  ...
  public static boolean distinct_declaration(PsiBuilder b, int l) {
    ...
    p = r; // pin = 1
    r = r && report_error_(b, type_name(b, l + 1));
    r = p && report_error_(b, distinct_declaration_2(b, l + 1)) && r;
  ...
  public static boolean enum_declaration(PsiBuilder b, int l) {
    ...
    p = r; // pin = 1
    r = r && report_error_(b, type_name(b, l + 1));
    r = p && report_error_(b, enum_declaration_2(b, l + 1)) && r;
  ...
  public static boolean fault_declaration(PsiBuilder b, int l) {
    ...
    p = r; // pin = 1
    r = r && report_error_(b, type_name(b, l + 1));
    r = p && report_error_(b, fault_declaration_2(b, l + 1)) && r;
  ...
  public static boolean func_def(PsiBuilder b, int l) {
    ...
    p = r; // pin = 1
    r = r && report_error_(b, func_header(b, l + 1));
    r = p && report_error_(b, fn_parameter_list(b, l + 1)) && r;
    r = p && func_def_3(b, l + 1) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
  ...
  public static boolean macro_definition(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, MACRO_DEFINITION, null);
    r = consumeToken(b, KW_MACRO);
    p = r; // pin = 1
    r = r && report_error_(b, macro_header(b, l + 1));
    r = p && report_error_(b, consumeToken(b, LP)) && r;
    r = p && report_error_(b, macro_params(b, l + 1)) && r;
    r = p && report_error_(b, consumeToken(b, RP)) && r;
    r = p && report_error_(b, macro_definition_5(b, l + 1)) && r;
    r = p && macro_func_body(b, l + 1) && r;
    exit_section_(b, l, m, r, p, null);
    return r || p;
  }
